...
int light = 0;              //this variable will hold a value based on the brightness of the ambient light
...
void loop()
{
  ...
  light = analogRead(A0);   //set photoresistor to a number between 0 and 1023 based on how bright the ambient light is
  light = map(light, 300, 800, 50, 1);
  Serial.println(light);    //print the value of photoresistor in the serial monitor on the computer
